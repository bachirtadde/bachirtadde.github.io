...
1. [article from this post](https://github.com/bachirtadde/bachirtadde.github.io/raw/master/download/article_Score_de_Propension.pdf)  
2. [slides for this post](https://github.com/bachirtadde/bachirtadde.github.io/raw/master/download/slides_Score_de_Propension.pdf)
...
Les covariables d’une étude statistique peuvent être réparties en 6 catégories comme indiqué dans la figure 1.
...
On peut identifier deux approches pour contrôler les biais dans une étude observationnelle :
  ...
  * **Modèle d’analyse multivarié** dont les forces et faiblesses sont :   
    ...
    - (-) Requiert des règles strictes pour une interprétation causale (Pearl, 2000)
    - (-) Limitation du nombre de covariables sinon problème de sur-ajustement

  * **Méthode du score de propension (Rosenbaum \& Rubin, 1983)**   dont les forces et faiblesses sont :   
...
# Méthode du Score de propension (Rosenbaum \& Rubin, 1983)
...
## Contrôle du  biais résiduel du fait de variables non-observables dans la méthode du score de propension  
...
Pearl, Judea. "Models, reasoning and inference." Cambridge, UK: CambridgeUniversityPress (2000).  \newline 

Moulis, G., and M. Lapeyre-Mestre. "Score de propension: intérêts, utilisation et limites. Un guide pratique pour le clinicien." La Revue de Médecine Interne 39.10 (2018): 805-812.
